    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-800 rounded-lg border border-slate-700 p-6">
                <form action="{{ route('admin.events.fights.store', $event) }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="red_fighter" id="red_fighter" value="{{ old('red_fighter') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="red_odds" id="red_odds" value="{{ old('red_odds') }}" placeholder="-150"
                                    class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-gray-200 focus:ring-orange-500 focus:border-orange-500">
                                @error('red_odds')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="blue_fighter" id="blue_fighter" value="{{ old('blue_fighter') }}"
                                    class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-gray-200 focus:ring-orange-500 focus:border-orange-500"
                                    required>
                                @error('blue_fighter')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="text" name="blue_odds" id="blue_odds" value="{{ old('blue_odds') }}" placeholder="+130"
                                    class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-gray-200 focus:ring-orange-500 focus:border-orange-500">
                                @error('blue_odds')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="weight_class" id="weight_class"
                                ...
                                @foreach ($weightClasses as $class)
                                    <option value="{{ $class }}" {{ old('weight_class') === $class ? 'selected' : '' }}>
                                        {{ $class }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="bout_order" id="bout_order" value="{{ old('bout_order', $nextBoutOrder) }}" min="1"
                                class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-gray-200 focus:ring-orange-500 focus:border-orange-500"
                                required>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="is_main_event" value="1" {{ old('is_main_event') ? 'checked' : '' }}
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="is_co_main" value="1" {{ old('is_co_main') ? 'checked' : '' }}
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="is_swimmies" value="1" {{ old('is_swimmies') ? 'checked' : '' }}
