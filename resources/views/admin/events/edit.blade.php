...
<div class="py-12">
    <div class="max-w-3xl mx-auto px-4">
        <div class="mb-8">
            ...
            <h2 class="text-3xl font-bold text-slate-100 mt-4">Edit Event</h2>
        </div>

        <form action="{{ route('admin.events.update', $event) }}" method="POST" class="bg-slate-800 rounded-2xl p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="status" required
                        ...
                        <option value="locked" {{ $event->status === 'locked' ? 'selected' : '' }}>Locked</option>
